          ...
          (e = e.replace(
            ...
            function(e, t, n, s, o) {
              ...
              var i = r.ghMentionsLink.replace(/\{u}/g, o),
                l = ""
              return (
                r.openLinksInNewWindow && (l = ' target="Â¨E95Eblank"'),
                t + '<a href="' + i + '"' + l + ">" + s + "</a>"
              )
            }
          )),
    ...
    g = function(e) {
      ...
      return function(r, t, n, s, o, i, l) {
        ...
        return (
          ...
          e.openLinksInNewWindow && (d = ' target="Â¨E95Eblank"'),
  ...
  a.subParser("autoLinks", function(e, r, t) {
        ...
        (e = e.replace(n, function(e) {
          return (
            ...
            (e = e.replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function(e, r) {
              var t = r
              return (
                (t = t.replace(/^  /gm, "Â¨0")), (t = t.replace(/Â¨0/g, ""))
              )
            })),
    ...
    a.subParser("detab", function(e, r, t) {
      ...
      return (
        ...
        (e = e.replace(/\t(?=\t)/g, "    ")),
        (e = e.replace(/\t/g, "Â¨AÂ¨B")),
        (e = e.replace(/Â¨B(.+?)Â¨A/g, function(e, r) {
      ...
      return (
        (e = a.helper.replaceRecursiveRegExp(
          ...
          function(e, n, s, o) {
            ...
            return "Â¨C" + (t.gHtmlSpans.push(i) - 1) + "C"
          },
          "<code\\b[^>]*>",
          "</code>",
          "gim"
    ...
    a.subParser("unescapeSpecialChars", function(e, r, t) {
      ...
      return (
        ...
        (e = e.replace(/Â¨E(\d+)E/g, function(e, r) {
          var t = parseInt(r)
